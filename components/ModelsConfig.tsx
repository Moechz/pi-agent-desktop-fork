      ...
      <div className="t-modal is-open ui-dialog-surface" style={{ width: "100%", maxWidth: 860, height: "78vh", background: "var(--material-popover)", border: "1px solid var(--border)", borderRadius: 14, display: "flex", flexDirection: "column", boxShadow: "var(--shadow-popover)", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 18px", borderBottom: "1px solid var(--border)", flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
            ...
            <code style={{ fontSize: 12, color: "var(--text-muted)", fontFamily: "var(--font-mono)" }}>~/.pi/agent/models.json</code>
          </div>
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "8px 6px" }}>
              ...
              {activeApiKey.map((p) => {
                ...
                return (
                  ...
                  >
                    <ProviderIcon id={p.id} size={16} />
                    <span style={{ fontSize: 13, color: "var(--text)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{p.displayName}</span>
                  </div>
                );
              })}
              ...
              {/* Custom providers */}
              {loading ? (
                <div style={{ padding: "10px 8px", fontSize: 13, color: "var(--text-muted)" }}>{t("models.loading")}</div>
                ...
                return (
                  <div key={pName} style={{ marginBottom: 2 }}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 13, fontWeight: isProviderSelected ? 600 : 400, color: "var(--text)", fontFamily: "var(--font-mono)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        {pName}
                      </span>
                    </div>
                    ...
                    {models.map((m, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {m.reasoning && (
                            <span style={{ fontSize: 11, padding: "1px 4px", background: "rgba(99,102,241,0.12)", color: "rgba(99,102,241,0.8)", borderRadius: 3, flexShrink: 0 }}>T</span>
                          )}
                        </div>
                      );
                    })}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 10, padding: "10px 18px", borderTop: "1px solid var(--border)", flexShrink: 0 }}>
          {saveError && <span style={{ fontSize: 13, color: "var(--danger)", flex: 1 }}>{saveError}</span>}
