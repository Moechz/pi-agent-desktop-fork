...
function AddSkillPanel({
  ...
  const search = useCallback(async (q: string) => {
    ...
    setResults([]);
    try {
      const res = await fetch(withBasePath("/api/skills/search"), {
        method: "POST",
  ...
  const install = useCallback(
    async (pkg: string) => {
      ...
      try {
        const res = await fetch(withBasePath("/api/skills/install"), {
          method: "POST",
          headers: { "Content-Type": "application/json" },
...
export function SkillsConfig({
  ...
  const toggle = useCallback(async (skill: Skill) => {
    ...
    setSaveError(null);
    try {
      const res = await fetch(withBasePath("/api/skills"), {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
