    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <button onClick={onDelete}
          style={{ padding: "3px 8px", background: "none", border: "1px solid var(--danger-border)", borderRadius: 4, color: "var(--danger)", cursor: "pointer", fontSize: 12 }}>
          {t("common.delete")}
        </button>
      </div>

      <Field label={t("provider.providerName")}>
        <TextInput value={editingName} onChange={setEditingName} placeholder={t("modelsConfig.exampleProviderName")} mono />
